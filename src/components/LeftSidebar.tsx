...
<div className="bg-yellow-100 p-6" style={{ width: '250px' }}>
      ...
      <div className="bg-green-800 text-white text-center py-4 mb-6">
        <h2 className="text-2xl font-bold">THE WEEK AHEAD</h2>
      </div>
      ...
      {events.map((event, index) => (
        <div key={index} className="mb-8">
          ...
          <div className="ml-6">
            ...
            <div className="mb-4">
              <span className="inline-block w-4 h-4 bg-gray-400 mr-2"></span>
              <span className={`${event.badgeColor} text-white px-3 py-1 font-bold inline-block`}>
                {event.badge}
              </span>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-600 text-base mt-2">
                <span className="underline decoration-dotted">{event.description}</span>{' '}
