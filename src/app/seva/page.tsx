      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          ...
          <div className="leading-relaxed mb-8" style={{color: '#333333'}}>
            ...
            <p className="mb-6">
              The Seva will be performed at <strong className="text-blue-600">Shri Mahalasa Narayani's Temple at Harikhandige</strong>. The Prasad will be sent to you by post. <em>At Harikhandige, there is no fixed rate since Service to God is not a commercial venture</em>. Please send a Money Order for any amount you wish, to:
            </p>
          </div>
          ...
          <div className="mb-8 leading-relaxed" style={{color: '#333333'}}>
            ...
            <p className="mb-6"><strong>INDIA</strong>.</p>
          </div>
          ...
          <div className="mb-8 leading-relaxed" style={{color: '#333333'}}>
            ...
            <div className="mb-4">
              ...
              <p className="mb-2">A/c No is <strong>520101232336071</strong>.</p>
              <p className="mb-4"><strong>IFSC Code UBIN0901288</strong> .</p>
            </div>
            
            <div className="mb-6">
              <p className="mb-2">Shri Mahalasa Narayani Devi Kshetra,</p>
              <p className="mb-2">Canara Bank, Perdoor Branch.</p>
              <p className="mb-2">A/c No is <strong>0130200083045</strong>.</p>
              <p className="mb-4"><strong>IFSC : CNRB0010130</strong></p>
            </div>
          </div>
          ...
          <div className="mb-8 leading-relaxed" style={{color: '#333333'}}>
            ...
            <p className="mb-4">
              Send e-mail to: <strong className="text-blue-600">sureshjpai@gmail.com</strong>. or alternatively, call on Whatsapp number <strong>8970414801</strong> for seva at Harikhandige.
            </p>
            
            <p className="mb-6">
              kindly note in case you wish to order seva At Mahalasa Saunsthan ,Mardol-Goa contact : <strong>9511214430</strong>
            </p>
          </div>
