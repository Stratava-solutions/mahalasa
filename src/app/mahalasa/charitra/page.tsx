    ...
    >
      ...
      <div className="container mx-auto px-4 py-6 max-w-6xl text-primary">
        ...
        <div className=" p-6 rounded-lg shadow-sm mb-6">
          ...
          <div className="mb-8">
            <div className="flex items-start mb-6">
              <div className="mr-6 flex-shrink-0">
                ...
                >
                  <div className="bg-white p-2 h-full flex flex-col items-center justify-center text-xs">
                    <Image
                      width={200}
                      height={200}
                      src="/devi_maha.jpg"
              ...
              <div className="flex-1 leading-relaxed">
                <p className="mb-4">
                  <strong>
                    The Charitra of Goddess Shri Mahalasa Narayani is considered
                    as the Bhagwad Gita for Kulavis and other followers of Shri
                    Mahalasa Narayani.
                  </strong>
                </p>
                <p className="mb-4">
                  A Parayan or proper reading of the book not only gives one
                  peace of mind, but it is also said to have brought out many
                  devotees from their state of distress. Many have said that
                  this book changed their lives for the better.
                </p>
                <p className="mb-4">
                  <strong>
            ...
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1 leading-relaxed">
                <p className="mb-4">
                  To get the Charitra , one can contact Shri Mahalasa Narayani
                  temple at <strong>Harikhandige, Mardol and Kumta</strong>
                </p>
                <p className="mb-4">You can also contact :</p>
                <p className="mb-2">
                  On whatsapp: <strong>8970414801</strong>
                </p>
                <p className="mb-4">
                  or email at <strong>sureshjpai@gmail.com</strong> for future
                  correspondence.
                </p>
              </div>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-orange-100 border-2 bg-orange_bg border-orange-300 rounded-lg p-4 mb-6">
              <div className="flex items-start">
                ...
                <div className="text-md leading-relaxed italic">
                  <p>
                    <em>
                      The benefits of reading the Charitra will be manifold and
                      immediate if read with faith, utter devotion, happiness
                      and concentration.
                    </em>
                  </p>
                </div>
            ...
            <div className="leading-relaxed">
              <ul className="space-y-2 mb-6">
                ...
                <li>
                  • The place where you are sitting while reading should be
                  clean.
                </li>
                <li>
                ...
                <li>
                  • The reading should be commenced with Shri Mahalasa
                  Narayani's Kavacaham and Asshottara Shatnamamantra (given in
                  the Charitra itself.)
                </li>
                <li>
                  • Tribhuvaneshwari Devi's blessed book should be kept at home
                  and worshipped with gandha (sandalwood paste) and flowers. It
                  should be kept perferably in a silk cloth.
                </li>
                <li>
          ...
          {/* Pricing Section */}
          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">Coverprice:</h3>
            <div className="leading-relaxed">
              <ul className="space-y-1 mb-6">
                <li>
                  • <strong>Kannada:</strong> Rs 140
                </li>
                <li>
                  • <strong>Marathi:</strong> Rs 215
                </li>
                <li>
                  • <strong>English:</strong> Rs 150
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="leading-relaxed">
              ...
              <p className="mb-4">
                Alternatively, kindly send email at{" "}
                <strong>sureshjpai@gmail.com</strong> for future correspondence.
              </p>

              <p className="font-semibold mb-2">Bank Account Details :</p>
              <p className="mb-2">Shri Mahalasa Narayani Devi Kshetra</p>
              <p className="mb-4">
                Canara Bank, A/c. Perdoor : <strong>0130200083045</strong> IFSC:{" "}
                <strong>CNRB0010130</strong>
              </p>

              <p className="mb-2">Shri Mahalasa Narayani Devi Kshetra</p>
              <p className="mb-4">
                Union Bank, A/c. Manipal: <strong>520101232336071</strong> IFSC:{" "}
                <strong>UBIN0901288</strong>
              </p>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1 leading-relaxed">
                <p className="mb-4">
                  His Holiness Guruji Shri Suresh J Pai, the Dharmadarshi of
                  Shri Mahalasa Narayani Devi Kshetra, Harikhandige, is the
                  author of The Charitra of Shri Mahalasa Narayani.
                </p>
                <p className="mb-4">
          ...
          <div className="mb-8">
            <h3 className="text-lg font-bold mb-4">
              Other Publications from Harikhandige
            </h3>
