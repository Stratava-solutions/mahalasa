    ...
    <div className="min-h-screen" style={{background: 'linear-gradient(135deg, #f5f2d8 0%, #ede8c8 100%)'}}>
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold mb-4" style={{color: '#006633'}}>Did You Know?</h1>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          ...
          {/* Kumkum Section */}
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Kumkum</h2>
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1 leading-relaxed" style={{color: '#333333'}}>
                <p className="mb-4">
                  You can give cash, gold, fruits and flowers as offerings to Shri Mahalasa Narayani. But She can be pleased with a devotee with only a very simple offering of Kumkum (vermillion). <strong style={{color: '#006633'}}>The devotee's faith is more important than his offering.</strong>
                </p>
                <p>
                  Performing a kumkumarchana, especially with Shri Mahalasa Ashtottara, is highly beneficial.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>The Holy Thread</h2>
            <p className="leading-relaxed italic mb-4" style={{color: '#333333'}}>
              <em>Shri Mahalasa wears a Janmaue or Yadnopavita or the Holy Thread? This is rare for a Goddess!</em>
            </p>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Jagruk Devata</h2>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Profound impact</h2>
            <p className="leading-relaxed italic mb-4" style={{color: '#333333'}}>
              <em>Many of the prayers, stuthis and stotras devoted to Her are not only pleasing to listen to, but also have a profound impact on the listener. These are but ways of reaching out to Her. Anyone who calls out to Her is sure to receive Her attention.</em>
            </p>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Shri Mahalasa's Charitra</h2>
            <div className="flex items-start mb-4">
              <div className="mr-6 flex-shrink-0">
                <div className="bg-blue-100 p-2 rounded text-center" style={{width: '120px', height: '140px'}}>
              ...
              <div className="flex-1 leading-relaxed" style={{color: '#333333'}}>
                <p className="mb-4">
                  The Charitra of Goddess Mahalasa Narayani, authored by His Holiness Guruji Shri Suresh J. Pai (of Shri Mahalasa Narayani Devi Kshetra, Harikhandige, fame), came as a direct command from the Goddess, who appeared to him in the course of a dream.
                </p>
                <p className="mb-4">
            ...
            <p className="leading-relaxed mb-4" style={{color: '#333333'}}>
              The Charitra is available in English, Kannada and Marathi versions. To know more about the Charitra and the correct way of reading it, <span className="text-blue-600 cursor-pointer">click here</span>.
            </p>
          </div>
            ...
            <div className="bg-orange-100 border-2 border-orange-300 rounded-lg p-4 mb-6">
              <div className="flex items-start">
                ...
                <div className="text-sm leading-relaxed" style={{color: '#333333'}}>
                  <p>
                    <em>Then there are those who keep printed versions of the Kavacham in their breast pocket as a virtual shield! And, rarely do these people face any major problems...</em>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Sunday, Her day | Palakhi Seva</h2>
            <div className="flex items-start mb-4">
              <div className="mr-6 flex-shrink-0">
                <div className="bg-gray-100 p-2 rounded text-center" style={{width: '180px', height: '120px'}}>
                  <div className="bg-white p-2 h-full flex items-center justify-center text-xs text-gray-600">
                    <div className="text-center">Ecstatic devotees go round Shri Mahalasa's Palakhi at Harikhandige.</div>
                  </div>
                </div>
              </div>
              <div className="flex-1 leading-relaxed" style={{color: '#333333'}}>
          ...
          {/* Navaratri Section */}
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Navaratri</h2>
            <p className="leading-relaxed mb-4" style={{color: '#333333'}}>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Direct participation</h2>
            <p className="leading-relaxed mb-4" style={{color: '#333333'}}>
              It is amazing that Shri Mahalasa Narayani Devi Kshetra, Harikhandige, is one spiritual centre where the direct participation of devotees — along with vaidiks and priests, or individually — is wholesomely encouraged in many poojas and yajnas and on special occasions. On certain days, the devotees themselves can perform the Kumkumarchana at Her feet or perform the full pooja, including Abhishek seva, to Lord Gurudatta at the spiritually powerful Datta Peetha.
            </p>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>The four-and-a-half gotras</h2>
            <p className="leading-relaxed mb-4" style={{color: '#333333'}}>
            ...
            <p className="leading-relaxed text-sm mb-4" style={{color: '#333333'}}>
          ...
          {/* Her Kulavis Section */}
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Her Kulavis</h2>
            <p className="leading-relaxed mb-4" style={{color: '#333333'}}>
              <em>Shri Mahalasa is worshipped by a large section of the Hindu society. Her Kulavis are mainly Gowda Saraswat Brahmins. Other include the Daivgna and Karhade Brahmins, who also consider Shri Mahalasa to be their family deity. Interestingly, they too are from the above-mentioned "four and a half" Gotras. Then, there are some Vaishyas (traders) Sonars (goldsmiths) and so on, who also follow Shri Mahalasa.</em>
            </p>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4" style={{color: '#006633'}}>Parashurama's instructions</h2>
            <p className="leading-relaxed mb-4" style={{color: '#333333'}}>
            ...
            <p className="font-semibold mb-4" style={{color: '#006633'}}>She is to be worshipped by reciting 24 names:</p>
            <p className="leading-relaxed mb-4" style={{color: '#333333'}}>
              <strong>Durga, Bhadrakali</strong>, Vijaya, Vaishnavi, Kumuda, Dandika, Krishna, Madhavi, Kanyaka, Maya, Narayani, Shanta, Sharada, Ambika, Katyayani, Baldurga, Maha Yogini, Adhishwari, Yog Nidra, <strong>Mahalaxmi, Kalratri, Mohini, Sarva Deu Namaskarya</strong>, and, <strong>Bharati</strong>.
            </p>
            
            <p className="font-semibold mb-6" style={{color: '#006633'}}>And, says Lord Parshurama, "She will fulfill all your wishes."</p>
          </div>
          ...
          <div className="bg-orange-100 border-2 border-orange-300 rounded-lg p-6 mb-6">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm leading-relaxed italic mb-4" style={{color: '#333333'}}>
                  <em>Blessed be the devotees of Mother Mahalasa with peace and happiness in their spiritual and material life and let all their wishes be fulfilled by Shri Mahalasa Devi. We pray at the Lotus Feet of Shri Mahalasa Narayani for the well-being and prosperity of all the visitors to this website.</em>
                </p>
